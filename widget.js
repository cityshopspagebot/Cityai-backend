...
".cai-chip{background:transparent;border:1px solid #3A3A45;color:#D8D8E2;font:inherit;font-size:13px;"+
"font-weight:500;padding:9px 16px;border-radius:40px;cursor:pointer;transition:.15s}"+
".cai-chip:hover{background:#232329;border-color:#55556A;color:#fff}"+
".cai-chip.cai-go{background:#FFD900;border-color:#FFD900;color:#000;font-weight:600}"+
...
".cai-cmp{display:flex;gap:10px;padding:14px 20px;border-top:1px solid #2A2A31;background:#1C1C22;"+
"flex-shrink:0;align-items:center}"+
".cai-cmp input{flex:1;padding:13px 18px;border:1px solid #33333E;border-radius:40px;font:inherit;"+
"font-size:14.5px;outline:0;color:#fff;background:#17171B;min-width:0}"+
".cai-cmp input:focus{border-color:#FFD900}"+
".cai-snd{width:44px;height:44px;border-radius:50%;background:#FFD900;color:#000;border:0;cursor:pointer;"+
...
mount.insertAdjacentHTML("beforeend",
  '<div id="cai-panel" role="region" aria-label="CityAI assistant">'+
    '<div class="cai-hd"><div class="cai-av">CA</div><div><h4>CityAI</h4>'+
